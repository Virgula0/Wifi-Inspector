...
This is a very simple tool made to show how many netowrks are currently saved on your computer showing also theri password in clear format. All happens in an automatically way but you can check manually in order to have the same result , by typing in cmd only 2 commands!
